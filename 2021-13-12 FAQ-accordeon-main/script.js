...

{
   ...
   function faqMenu() {
      ...
      for (let i = 0; i < getAnswers.length; i++){
         ...
         console.log(getAnswersHeight[i]);
      ...
      console.log(getAnswers[1].scrollHeight);
      ...
      //als mouseover vragen maak vraag rood en voeg muishandje toe
      for (let i = 0; i < getQuestions.length; i++) {
         ...
         function mouseClick() {
            ...
            console.log(getAnswers[i].style.padding);
         }
      }
   }
}